...
with open('model_rfc_default.pkl', 'rb') as f:
    model = pickle.load(f)   
...
def preprocessing_data(data) -> pd.DataFrame:
    ...
    try:
        ...
        features_for_model = [
            'Flow_Duration','Total_Fwd_Packets','Total_Length_of_Fwd_Packets','Fwd_Packet_Length_Max',
            'Fwd_Packet_Length_Min','Fwd_Packet_Length_Mean','Bwd_Packet_Length_Max','Bwd_Packet_Length_Min',
            'Flow_Bytes_s','Flow_Packets_s','Flow_IAT_Mean','Flow_IAT_Min','Fwd_IAT_Min','Bwd_IAT_Total','Bwd_IAT_Mean',
            'Bwd_IAT_Std','Bwd_IAT_Min','Fwd_PSH_Flags','Bwd_PSH_Flags','Fwd_URG_Flags','Bwd_URG_Flags','Fwd_Header_Length',
            'Bwd_Packets_s','Min_Packet_Length','FIN_Flag_Count','RST_Flag_Count','PSH_Flag_Count','ACK_Flag_Count',
            'URG_Flag_Count','Down_Up_Ratio','Fwd_Avg_Bytes_Bulk','Fwd_Avg_Packets_Bulk','Fwd_Avg_Bulk_Rate','Bwd_Avg_Bytes_Bulk',
            'Bwd_Avg_Packets_Bulk','Bwd_Avg_Bulk_Rate','act_data_pkt_fwd','Active_Mean','Active_Std','Active_Min','Idle_Std'
        ]
